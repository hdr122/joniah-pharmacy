...
const activityTypeLabels: Record<string, { label: string; icon: React.ReactNode; color: string }> = {
  login: { label: "تسجيل دخول", icon: <LogIn className="w-4 h-4" />, color: "bg-gradient-to-r from-green-500 to-violet-600 text-white" },
  ...
  order_create: { label: "إضافة طلب", icon: <Plus className="w-4 h-4" />, color: "bg-gradient-to-r from-violet-500 to-fuchsia-600 text-white" },
    ...
    <div className="space-y-6 p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <Card className="border-none shadow-lg hover:shadow-xl transition-all duration-300">
          <CardContent className="pt-6">
            <div className="flex items-center gap-4">
              <div className="w-14 h-14 bg-gradient-to-br from-green-500 to-violet-600 rounded-2xl flex items-center justify-center shadow-lg">
                ...
                <TableBody>
                  {userStats.map((stat) => (
                    <TableRow key={stat.userId} className="hover:bg-muted/30 transition-colors">
                      ...
                      <TableCell>
                        <Badge variant="outline" className="bg-accent/50 border-green-200 text-green-700 font-semibold">
                          {(stat.loginCount || 0).toLocaleString('en-US')}
                        </Badge>
                      </TableCell>
                      <TableCell>
                        <Badge variant="outline" className="bg-accent/50 border-violet-200 text-violet-700 font-semibold">
                      ...
                      <TableCell>
                        <Badge variant="outline" className="bg-accent/50 border-purple-200 text-purple-700 font-semibold">
              ...
              {totalPages > 1 && (
                <div className="flex items-center justify-center gap-3 mt-6">
                  <Button
                    ...
                    disabled={page === 0}
                    className="hover:bg-violet-50 hover:text-violet-600 hover:border-violet-300"
                  >
                    السابق
                  </Button>
